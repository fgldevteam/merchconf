		...
		if(hasError == false) {
			...
			$.post("sendEmail.php",
   				{ fname: fnameVal,
   				  ...
   				  emergencyNumber: emergencyNumberVal,
   				  shirt: shirtVal,
   				  jacket: jacketVal,
   				  shoes: shoesVal
 //  				  deline: declineVal
   					...
   					function(data){
						$("#regform").slideUp("normal", function() {				  						
							...
							$("#regform").before("<h3>Thank You!</h3><p style='font-size: 16px;'>Your submission has been received. You will receive an email from us containing all of your registration info.</p>");											
						});
   					}
				 );
		}			
